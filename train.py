...
class Base(pl.LightningModule):
    ...
    def setup_steps(self, model, stage=None):
        ...
        train_loader = self.trainer.request_dataloader(stage=RunningStage.TRAINING, model=model)
    ...
    def configure_optimizers(self):
        ...
        data_len = self.setup_steps(self, self.model)
